...
(function(){
  ...
  /* APPS fold, PROPOSAL 2026-09-07 (not live, Jade decides): one rack in place of JELLYBOI / NOISEFACE / WAVEFACE / TODOMAI.
   ...
   {name:'APPS', r:'16 WATCH APPS · 2 ON THE STORE', term:[['c','wc -l Watch/Sources/*.swift | tail -1'],['hi','    1252 total'],['c','find . -name \'*.swift\' -not -path \'./build/*\' | wc -l'],['o','      14'],['c','find WaveFace -name \'*.swift\' -print0 | xargs -0 wc -l | tail -1'],['o','    4069 total'],['c','ls images/apps/watch/*.mp4 | wc -l'],['hi','      16']], q:'Four apps, one lesson about the audio session.', load:{kind:'page',src:'demo-apps.html',label:'demo-apps.html'},
    mods:[
